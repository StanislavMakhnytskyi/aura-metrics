            ...
            <div className='space-y-8'>
              ...
              <div className='flex flex-col items-center gap-4'>
                ...
                <div className='text-muted-foreground flex items-center gap-4 text-sm'>
                  ...
                  <span>10B+ Daily Data Points</span>
                  <Separator orientation='vertical' className='!h-4' />
              ...
              <div className='space-y-6'>
                ...
                <p className='text-muted-foreground mx-auto max-w-2xl text-balance lg:text-xl'>
                  Stop querying databases manually. Create production-ready dashboards and sync reports that align your teams instantly.
                </p>
              </div>
              ...
              <div className='text-muted-foreground flex flex-wrap items-center justify-center gap-6 text-sm'>
                <div className='flex items-center gap-2'>
                  ...
                  <span>No credit card required to trial</span>
                </div>
                <div className='flex items-center gap-2'>
                    <div className='size-2 rounded-full bg-blue-600 dark:bg-blue-400 me-1' />

                  <span>GDPR, HIPAA & SOC2 Compliant</span>
                </div>
                <div className='flex items-center gap-2'>
