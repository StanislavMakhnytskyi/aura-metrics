...
const plans = [
  {
    name: 'Starter',
    description: 'Essential analytics for growing teams and startups',
    monthlyPrice: 49,
    yearlyPrice: 39,
    features: [
      'Up to 3 data sources',
      'Real-time dashboard updates (hourly)',
      '5 team member accounts',
      'Standard charting & reporting templates',
  ...
  {
    name: 'Growth',
    description: 'Complete business intelligence suites for scaling teams',
    monthlyPrice: 129,
    yearlyPrice: 99,
    features: [
      'Unlimited data sources',
      'Instant live dashboard sync',
      'Unlimited team members',
      'Custom KPI charting & formulas',
      'Priority slack & email support',
      'Advanced SQL & raw data exports',
  ...
  {
    name: 'Enterprise',
    description: 'Custom controls, security, and dedicated analytics backing',
    monthlyPrice: 499,
    yearlyPrice: 399,
    features: [
      'Dedicated data warehouse connection',
      'On-prem database tunneling',
      'SOC2 / HIPAA compliance settings',
      'Custom single sign-on (SSO/SAML)',
      'Dedicated BI Analyst support',
